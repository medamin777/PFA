...
exports.addHealthParameter=async(req,res)=>{
    const {heart_rate,blood_pressure,glucose_level,notes,temperature,oxygen_level}=req.body;
    ...
    try{  
        ...
        const notification=new Notification({
            sender:userId,
            receiver:doctor._id,
            message:`New Parameters Recorded from ${patient.user.firstName} ${patient.user.lastName}`,
            link:`/patient-details/${patient._id}`
